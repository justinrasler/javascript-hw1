...
const allFoods = foods[0] + " -> " + yummy[0] + " -> "  + yummy[1] + " -> "  + foods[1] + " -> " + foods[2]
...
//i found this solution online, I couldnt figure out how to add to the new array.
...
let fizzbuzz = nums.filter(n => n%3 && n%5 === 0)
